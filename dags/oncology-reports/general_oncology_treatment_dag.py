...
dag = DAG(
    'general_oncology_treatment_dag',
...
spark_context = PythonOperator(
    task_id='create_spark_context',
    provide_context=True,
    python_callable=create_spark_context,
    params={"name": "General Oncology Program"},
    dag=dag,
)

sql_context = PythonOperator(
    task_id='create_sql_context',
    provide_context=True,
    python_callable=create_sql_context,
    params={"spark_context": "spark_context"},
    dag=dag,
)
